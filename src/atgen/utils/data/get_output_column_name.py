...
def get_output_column_name(
    output_column_name: Union[DictConfig, ListConfig, dict[str, Union[str, list[str]]], list[str], str],
    ...
    if isinstance(output_column_name, (list, ListConfig)):
        ...
        raise NotImplementedError(f"Unexpected type {type(output_column_name)} of the output column name.")
